...
const Blog = (props: Props) => {
  ...
  return (
    <div className=' h-full flex items-center flex-wrap justify-center  text-white  italic  disable-select  '>{
      props.post.map((post:Data,key:any)=>(
        <Link href={`/post/${post._id}`} key={key}>
        <div  className='text-center my-3 w-52 hover:text-cyan-400 mx-2 ' key={key}>
